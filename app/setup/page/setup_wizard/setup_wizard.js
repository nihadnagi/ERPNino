wn.pages['setup-wizard'].onload = function(wrapper) { 
	...
	erpnext.wiz = new wn.wiz.Wizard({
		...
		title: wn._("ERPNino Setup Guide"),
		welcome_html: '<h1 class="text-muted text-center"><i class="icon-magic"></i></h1>\
			<h2 class="text-center">'+wn._('ERPNino Setup')+'</h2>\
			<p class="text-center">' + 
			wn._('Welcome to ERPNino. Over the next few minutes we will help you setup your ERPNino account. Try and fill in as much information as you have even if it takes a bit longer. It will save you a lot of time later. Good Luck!') + 
			'</p>',
