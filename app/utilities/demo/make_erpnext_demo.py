...
def make_demo_login_page():
	...
	p.doc.published = 1
	p.doc.description = "ERPNino Demo Login"
...
def make_demo_on_login_script():
	...
	cp.doc.custom_startup_code = """wn.ui.toolbar.show_banner('You are using ERPNino Demo. To start your own ERPNino Trial, <a href="https://erpnext.com/pricing-and-signup" target="_blank">click here</a>')"""
	cp.save()
